...
function PreviewDialogBtn() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-screen h-screen max-h-screen max-w-full bg-[#E2E8F0]  flex flex-col flex-grow p-0 gap-0">
        <div className="px-4 py-2 border-b">
          <p className="text-lg font-bold text-black ">Form preview</p>
          <p className="text-sm text-black">
            This is how your form will look like to your users.
          </p>
        </div>
        <div className="bg-accent flex flex-col flex-grow items-center justify-center p-4 bg-[url(/paper.svg)] dark:bg-[url(/paper-dark.svg)] overflow-y-auto">
          <div className="max-w-[700px] flex flex-col gap-4 flex-grow bg-[#E2E8F0] h-full w-full rounded-2xl p-8 overflow-y-auto">
